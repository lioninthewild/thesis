...
Where:
\begin{itemize}
    \item $m$ = number of observable metadata attributes (in our model, $m = 7$)
...
Where $m$ is the number of observable metadata attributes.
...
\begin{itemize}
    ...
    \item $m$ = number of observable metadata attributes
\end{itemize}
