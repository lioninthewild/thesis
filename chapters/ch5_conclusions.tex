...
This chapter synthesises the findings of this work, provides
...
This work developed a formal, normalised metadata
...
from first principles. The single-attribute uniqueness score ($s(a_i)$) measures the fraction of users uniquely identifiable
...
Address, and Zero-Knowledge Proof Token, across seven metadata attributes
...
Hybrid Scheme 0.067, and Zero-Knowledge Proof Token 0.035. The six schemes form
a clean, non-overlapping risk ladder. Zero-Knowledge Proof Token is 9.1 times
...
5.5 times the risk of Zero-Knowledge Proof Token at the same scale. Zero-Knowledge Proof Token
...
$\Rnorm = 0.002$, within 0.001 of Zero-Knowledge Proof Token with full mitigation.
...
This work makes five contributions to the existing body of
knowledge.
...
This work provides the first quantitative comparison of six
...
infrastructure, this work provides the first formal privacy risk
...
($N = 50$), all schemes except Zero-Knowledge Proof Token exceed
...
Based on the findings of this work, the following specific
...
mitigation stack, near-Zero-Knowledge Proof performance at significantly lower
computational cost.
...
\textbf{Recommendation 6, Use Zero-Knowledge Proof Token only if computational
constraints can be resolved.} Zero-Knowledge Proof Token is the only scheme with
scale-independent risk. If NRB can resolve its computational
requirements through tiered CBDC architecture or offline zero-knowledge proof
verification, it should be the target deployment scheme.

\textbf{Recommendation 7, Conduct any village pilot under
Ring Signature or better.} At $N = 50$, all schemes except Zero-Knowledge Proof Token
...
modeled, transaction ID linkability, endorsing peer identity,
...
with a full mitigation stack delivers near-Zero-Knowledge Proof privacy at a
fraction of Zero-Knowledge Proof Token's computational cost. Nepal does not have to
