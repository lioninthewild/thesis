...
in Appendix~\ref{app:a_code}.
% ================================================================
\section{Analysis 3 Six-Scheme Comparison}\label{sec:a3}
% ================================================================
...
Zero-Knowledge Proof Token         & 0.982 & 0.035 & 3.5\%  & Very Low\\
\bottomrule
\end{tabular}
\end{table}
...
Zero-Knowledge Proof Token, with its nullifier pool of size $N \times 100$,
shows the single-attribute uniqueness score for the wallet attribute ($s(\text{wallet}) = 0.982$), nearly every user has a
...
and Zero-Knowledge Proof Token produce per-transaction wallets with no
mathematical link between them, breaking the spending pattern
attack even when the single-attribute uniqueness score for the wallet attribute ($s(\text{wallet})$) is high.
...
transaction zone show the single-attribute uniqueness score ($s(a_i) = 0.000$) across all schemes at
...
% ================================================================
\section{Analysis 5 Population Scalability}\label{sec:a5}
% ================================================================
...
Immediate plateau\\
Zero-Knowledge Proof Token        & 0.035 & 0.035 & 0.035 & 0.035 & 0.035 &
Completely flat\\
\bottomrule
\end{tabular}
\end{table}
...
Zero-Knowledge Proof Token baseline (bottom right). $m = 7$.}
...
5.5 times the risk of Zero-Knowledge Proof Token at the same scale. A
...
\textbf{Zero-Knowledge Proof Token is scale-independent.} Zero-Knowledge Proof Token is the
only scheme whose $\Rnorm$ is completely flat across all
population sizes, 0.035 at $N = 100$ and 0.035 at
$N = 100{,}000$. This occurs because Zero-Knowledge Proof Token's nullifier pool
...
% ================================================================
\section{Analysis 7 Mitigation Effectiveness}\label{sec:a7}
% ================================================================
...
HS = Hybrid Scheme, ZKP = Zero-Knowledge Proof Token}
\end{tabular}
\end{table}
...
Because both attributes have the single-attribute uniqueness score ($s(a_i) = 0$) at $N = 1{,}000$
...
($\Rnorm = 0.002$) reach near-identical performance to Zero-Knowledge Proof Token
...
full mitigation as a practical alternative to Zero-Knowledge Proof Token for
deployments where Zero-Knowledge Proof Token's computational cost is prohibitive.

% ================================================================
\section{Analysis 8 m-Attribute Sensitivity}\label{sec:a8}
% ================================================================
...
% ================================================================
\section{Analysis 9 Seed Sensitivity}\label{sec:a9}
% ================================================================
...
Zero-Knowledge Proof Token         & 0.0354 & 0.0001 & 0.3  & [0.035, 0.036]\\
\bottomrule
\end{tabular}
\end{table}
...
outperforms a stronger one. The ordinal ranking, Zero-Knowledge Proof Token,
Hybrid/Ring, Stealth, Blind, Plain Hash, is preserved in
every trial. The conclusions of this work are not sensitive
...
Signature (CV 0.3\%), Stealth Address (CV 0.1\%), and Zero-Knowledge Proof Token
Token (CV 0.3\%) are nearly deterministic. Their results
are functionally independent of the random seed.

% ================================================================
\section{Analysis 10 Micro-Scale Pilot Test}\label{sec:a10}
% ================================================================
...
Zero-Knowledge Proof Token        & 0.721 & 0.107 & 0.071 & 0.035 & 0.035\\
\bottomrule
\end{tabular}
\end{table}
...
all schemes except Zero-Knowledge Proof Token Token exceed $\Rnorm = 0.48$. This
...
\textbf{Zero-Knowledge Proof Token is the only scheme safe at micro-scale.}
Zero-Knowledge Proof Token drops to $\Rnorm = 0.071$ at $N = 50$, compared
...
pilot, Zero-Knowledge Proof Token is the only scheme that provides adequate
...
% ================================================================
\section{Analysis 11 Lambda Sensitivity}\label{sec:a11}
% ================================================================
...
(left) and Zero-Knowledge Proof Token (right). Yellow dashed line = $\lambda
...
\textbf{Zero-Knowledge Proof Token is completely immune to lambda.}
Zero-Knowledge Proof Token's $\Rnorm$ remains flat at 0.035 regardless of
$\lambda$ varying from 0 to 100. This is because Zero-Knowledge Proof Token reduces
...
regardless of $\lambda_{ij}$. This demonstrates that Zero-Knowledge Proof Token
...
% ================================================================
\section{Analysis 12 Worst-Case Scenario}\label{sec:a12}
% ================================================================
...
Zero-Knowledge Proof Token           & 0.982  & 0.035\\
...
comparison across Plain Hash Token, Zero-Knowledge Proof Token, and
...
\textbf{Zero-Knowledge Proof Token at 3.5\% of maximum is the standard to
target.} The worst-case configuration demonstrates what
zero cryptographic privacy engineering produces. Zero-Knowledge Proof Token's
...
% ================================================================
\section{Combined View Scheme, Scale, and Mitigation}\label{sec:combined}
% ================================================================
