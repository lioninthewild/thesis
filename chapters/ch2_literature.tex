...
work across six areas, the global CBDC landscape, privacy
...
identifying the specific research gap that this work fills.
...
This work is concerned exclusively with retail CBDC, which
...
ledger \cite{biscgide2024}. This work models token-based
...
programs, specifically the Bahamas Sand Dollar, Uruguay's e-Peso, and
...
directly relevant to this work, under hybrid architecture,
...
pattern analysis, which is the precise problem this work
quantifies.
...
a persistent identifier, namely a pseudonym, rather than a
...
by encrypted messaging and by zero-knowledge proof range proofs that hide
transaction amounts.

The critical insight motivating this work is that
...
This work addresses informational privacy, the risk of
...
ledger access. Six schemes are relevant to this work,
...
included in this work as the baseline worst-case scheme.
...
primitives. The hybrid scheme modeled in this work combines
...
\textbf{Zero-Knowledge Proof Token.} Zero-knowledge proof systems allow a
...
membership proofs used in CBDC privacy schemes. In a Zero-Knowledge Proof
...
unlinkability. Zero-Knowledge Proof tokens provide the strongest metadata
...
the work, which models exactly this amplification effect.
...
relevant to this work, k-anonymity, l-diversity, and
...
connection to this work is direct, the single-attribute
the single-attribute uniqueness score ($s(a_i)$) in the model of this work
...
$\lambda_{ij} \times s(a_i) \times s(a_j)$ in this work
...
cross-attribute combination problem central to this work
...
The model in this work measures the effect of such
...
de-anonymization problem as formulated in this work.
...
directly to the seven attributes modeled in this work,
...
interaction effect modeled in this work. The conceptual
connection between their attribute sensitivity framework
and the uniqueness-based approach in this work represents
...
model does not eliminate the privacy problem this work
...
\textbf{CBDC-specific} \\
\midrule
\cite{biscgide2024}        & Yes      & No      & No  & Yes  \\
\cite{moralesresendiz2021}  & No       & No      & No  & Yes  \\
\cite{garratt2020}          & No       & No      & No  & No   \\
\cite{koshy2014}           & No       & No      & No  & No   \\
\cite{chaum1983}           & No       & No      & No  & No   \\
\cite{asghar2011}          & No       & No      & No  & No   \\
\cite{vansaberhagen2013}   & No       & No      & No  & No   \\
\cite{noether2015}         & No       & No      & No  & No   \\
\textbf{This work}          & \textbf{Yes} & \textbf{Yes} &
\textbf{Yes} & \textbf{Yes} \\
\bottomrule
\addlinespace
\end{tabular}
...
This work fills that gap by deriving $R_{\mathrm{norm}}$,
